...
import { onAuthStateChanged, signOut, createUserWithEmailAndPassword, getAuth } from "https://www.gstatic.com/firebasejs/12.2.1/firebase-auth.js";
import {
...
onAuthStateChanged(auth,async u=>{
  ...
  if(!snap.exists()||!snap.data().ativo){await signOut(auth);return location.href="./login.html"}
  usuario=u;perfil=snap.data();$("#usuario-logado").textContent=`${perfil.nome} · ${perfil.perfil}`;
  aplicarPermissoes();abrirTab("pedidos");
});
